...
if __name__ == "__main__":
    ...
    if args.wandb:
        wandb.init(project='ICLR_csv_'+args.dataset+'_baseline', #'lr_test',#
    ...
    import csv
    with open('./'+'ICLR_csv_'+args.dataset+'_'+'DEEPHIT.csv','a',newline='') as f:
        wr = csv.writer(f)
        wr.writerow([val_loss, ctd, ibs, nbll, args])
